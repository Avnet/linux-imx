...
/* support Avnet panel TFT7201280 */
static const struct ili9881c_instr tft7201280_init[] = {
	//GIP_1
	...
	//GIP_2
	ILI9881C_COMMAND_INSTR(0x50,0x01),	//STV_1,2
	ILI9881C_COMMAND_INSTR(0x51,0x23),	//STV_3,4
	ILI9881C_COMMAND_INSTR(0x52,0x45),	//STV_5,6
	ILI9881C_COMMAND_INSTR(0x53,0x67),	//STV_7,8
	ILI9881C_COMMAND_INSTR(0x54,0x89),	//STV_9,10
	ILI9881C_COMMAND_INSTR(0x55,0xab),	//STV_11,12
	ILI9881C_COMMAND_INSTR(0x56,0x01),	//CLK_1.2
	ILI9881C_COMMAND_INSTR(0x57,0x23),	//CLK_3,4
	ILI9881C_COMMAND_INSTR(0x58,0x45),       //CLK_5,6
	ILI9881C_COMMAND_INSTR(0x59,0x67),       //CLK_7,8
	ILI9881C_COMMAND_INSTR(0x5a,0x89),       //CLK_9,10
	ILI9881C_COMMAND_INSTR(0x5b,0xab),       //CLK_11,12
	ILI9881C_COMMAND_INSTR(0x5c,0xcd),       //CLK_13,14
	ILI9881C_COMMAND_INSTR(0x5d,0xef),       //CLK_15,16
	...
	ILI9881C_COMMAND_INSTR(0x69,0x07),     //FW_CGOUT_L[11]
	...
	ILI9881C_COMMAND_INSTR(0x6e,0x02),     //FW_CGOUT_L[16]   STV2_R (STVA_3)
	...
	ILI9881C_COMMAND_INSTR(0x7f,0x07),     //BW_CGOUT_L[11]
	...
	ILI9881C_COMMAND_INSTR(0x84,0x02),     //BW_CGOUT_L[16]   STV2_R
	...
	ILI9881C_COMMAND_INSTR(0x00,0x82),    // 4LANE
	ILI9881C_COMMAND_INSTR(0x6E,0x2A),    //VGH Clamp 15V
	ILI9881C_COMMAND_INSTR(0x6F,0x35),    //VGH=3*VSP_VGL=-2.5*VSP
	ILI9881C_COMMAND_INSTR(0x8D,0x14),    //VGL Clamp -10V
	ILI9881C_COMMAND_INSTR(0x87,0xBA),
	ILI9881C_COMMAND_INSTR(0x26,0x76),
	ILI9881C_COMMAND_INSTR(0xB2,0xD1),
	ILI9881C_COMMAND_INSTR(0x3B,0x8F),    //PUMP SHIFT CLK
	ILI9881C_COMMAND_INSTR(0x35,0x1F),    //HZ_opt
	ILI9881C_COMMAND_INSTR(0x3A,0x24),    //PS_EN
	...
	ILI9881C_COMMAND_INSTR(0x33,0x14),    //First Blanking frame 設定為GND
	ILI9881C_COMMAND_INSTR(0x38,0x01),
	ILI9881C_COMMAND_INSTR(0x39,0x00),
	...
	ILI9881C_COMMAND_INSTR(0x22,0x0A),
	ILI9881C_COMMAND_INSTR(0x31,0x00),
	ILI9881C_COMMAND_INSTR(0x53,0x8D),
	ILI9881C_COMMAND_INSTR(0x55,0x8D),
	ILI9881C_COMMAND_INSTR(0x50,0x95),     //VREG1  4.5V
	ILI9881C_COMMAND_INSTR(0x51,0x90),     //VREG2 -4.5V
	ILI9881C_COMMAND_INSTR(0x60,0x26),     //SDT=2.5us
	ILI9881C_COMMAND_INSTR(0x62,0x07),     //EQ
	ILI9881C_COMMAND_INSTR(0x63,0x00),     //PC
	ILI9881C_COMMAND_INSTR(0x70,0xF5),
	ILI9881C_COMMAND_INSTR(0x71,0x01),

	//====================//   GAMMA Positive

	ILI9881C_COMMAND_INSTR(0xA0,0x00),
	ILI9881C_COMMAND_INSTR(0xA1,0x2B),
	ILI9881C_COMMAND_INSTR(0xA2,0x3A),
	ILI9881C_COMMAND_INSTR(0xA3,0x15),
	ILI9881C_COMMAND_INSTR(0xA4,0x18),
	ILI9881C_COMMAND_INSTR(0xA5,0x2B),
	ILI9881C_COMMAND_INSTR(0xA6,0x1F),
	ILI9881C_COMMAND_INSTR(0xA7,0x1F),
	ILI9881C_COMMAND_INSTR(0xA8,0xA0),
	ILI9881C_COMMAND_INSTR(0xA9,0x1D),
	ILI9881C_COMMAND_INSTR(0xAA,0x28),
	ILI9881C_COMMAND_INSTR(0xAB,0x86),
	ILI9881C_COMMAND_INSTR(0xAC,0x1B),
	ILI9881C_COMMAND_INSTR(0xAD,0x18),
	ILI9881C_COMMAND_INSTR(0xAE,0x4C),
	ILI9881C_COMMAND_INSTR(0xAF,0x21),
	ILI9881C_COMMAND_INSTR(0xB0,0x27),
	ILI9881C_COMMAND_INSTR(0xB1,0x53),
	ILI9881C_COMMAND_INSTR(0xB2,0x62),
	ILI9881C_COMMAND_INSTR(0xB3,0x39),

	//====================//  GAMMA Negative

	ILI9881C_COMMAND_INSTR(0xC0,0x00),
	ILI9881C_COMMAND_INSTR(0xC1,0x2B),
	ILI9881C_COMMAND_INSTR(0xC2,0x3A),
	ILI9881C_COMMAND_INSTR(0xC3,0x15),
	ILI9881C_COMMAND_INSTR(0xC4,0x18),
	ILI9881C_COMMAND_INSTR(0xC5,0x2B),
	ILI9881C_COMMAND_INSTR(0xC6,0x1F),
	ILI9881C_COMMAND_INSTR(0xC7,0x1F),
	ILI9881C_COMMAND_INSTR(0xC8,0xA0),
	ILI9881C_COMMAND_INSTR(0xC9,0x1D),
	ILI9881C_COMMAND_INSTR(0xCA,0x28),
	ILI9881C_COMMAND_INSTR(0xCB,0x86),
	ILI9881C_COMMAND_INSTR(0xCC,0x1B),
	ILI9881C_COMMAND_INSTR(0xCD,0x18),
	ILI9881C_COMMAND_INSTR(0xCE,0x4C),
	ILI9881C_COMMAND_INSTR(0xCF,0x21),
	ILI9881C_COMMAND_INSTR(0xD0,0x27),
	ILI9881C_COMMAND_INSTR(0xD1,0x53),
	ILI9881C_COMMAND_INSTR(0xD2,0x62),
	ILI9881C_COMMAND_INSTR(0xD3,0x39),
...
/* support Avnet panel TFT8001280 */
static const struct ili9881c_instr tft8001280_init[] = {
	ILI9881C_SWITCH_PAGE_INSTR(0x03),
	ILI9881C_COMMAND_INSTR(0x01,  0x00),
	ILI9881C_COMMAND_INSTR(0x02,  0x00),
	ILI9881C_COMMAND_INSTR(0x03,  0x73),
...
static int ili9881c_read_cmd_data(struct ili9881c *ctx, u8 cmd)
{
	u8 buf = 0;
	int ret;
...
static void ili9881c_get_devid(struct ili9881c *ctx)
{
	static u8 id[3];

	if( 0x98==id[0] && 0x81==id[1] && 0x1c==id[2] )
		return ;
...
static int ili9881c_enable(struct drm_panel *panel)
{
	...
	ret = backlight_enable(ctx->panel.backlight);
	if (ret) {
...
static const struct drm_display_mode tft7201280_default_mode = {
	.clock      = 66000,
...
static const struct drm_display_mode tft8001280_default_mode = {
	.clock      = 66000,

	.hdisplay   = 800,
	.hsync_start= 800 + 100,
	.hsync_end  = 800 + 100 + 20,
	.htotal     = 800 + 100 + 20 + 100,
...
static const struct ili9881c_desc tft7201280_desc = {
	.init = tft7201280_init,
	.init_length = ARRAY_SIZE(tft7201280_init),
	.mode = &tft7201280_default_mode,
	.mode_flags = MIPI_DSI_MODE_VIDEO | MIPI_DSI_MODE_VIDEO_SYNC_PULSE,
	.name = "avnet,tft7201280",
};

static const struct ili9881c_desc tft8001280_desc = {
	.init = tft8001280_init,
	.init_length = ARRAY_SIZE(tft8001280_init),
	.mode = &tft8001280_default_mode,
	.mode_flags = MIPI_DSI_MODE_VIDEO | MIPI_DSI_MODE_VIDEO_SYNC_PULSE,
	.name = "avnet,tft8001280",
};
...
static const struct of_device_id ili9881c_of_match[] = {
	...
	{ .compatible = "avnet,ph720128t003", .data = &ph720128t003_desc }, /* PH720128T003-ZBC02 */
	{ .compatible = "avnet,ph720128t005", .data = &ph720128t005_desc }, /* PH720128T005ZBC */
	{ .compatible = "avnet,tft7201280", .data = &tft7201280_desc }, /* TFT7201280 */
	{ .compatible = "avnet,tft8001280", .data = &tft8001280_desc }, /* TFT8001280 */
	{ }
};
