...
/* The default mode is deprecated. Use panel timing set in device tree instead. */
static struct drm_display_mode ph720128t003_default_mode = {
	.clock		= 66000, /* htotal*vtotal*fps = 900x1307x60.02= 70,601,526 */
...
static struct drm_display_mode lhr050h41_default_mode = {
	.clock		= 62000,
...
static struct drm_display_mode k101_im2byl02_default_mode = {
	.clock		= 69700,
...
static struct drm_display_mode tl050hdv35_default_mode = {
	.clock		= 59400,
...
static struct drm_display_mode w552946aba_default_mode = {
	.clock		= 64000,
...
static int ili9881c_dsi_probe(struct mipi_dsi_device *dsi)
{
	...
	compatible = of_get_property(dsi->dev.of_node, "compatible", NULL);
	...
	if (ret)
	{
		dev_err(&dsi->dev, "Couldn't get panel backlight\n");
		return ret;
	}
