...
static const struct snd_soc_dapm_widget imx_cs4344_dapm_widgets[] = {
...
static int imx_cs4344_late_probe(struct snd_soc_card *card)
{
...
static int imx_cs4344_probe(struct platform_device *pdev)
{
	...
	priv->dai[0].codecs->dai_name     = "cs4344-hifi",
	...
	priv->card.late_probe = imx_cs4344_late_probe;
	priv->card.num_links = 1;
	priv->card.dev = &pdev->dev;
	priv->card.owner = THIS_MODULE;
	priv->card.dapm_widgets = imx_cs4344_dapm_widgets;
	priv->card.num_dapm_widgets = ARRAY_SIZE(imx_cs4344_dapm_widgets);
	...
	if (asrc_pdev) {
		...
		priv->dai[2].codecs->dai_name  = "cs4344-hifi";
...
static const struct of_device_id imx_cs4344_dt_ids[] = {
	{ .compatible = "fsl,imx-audio-cs4344", },
	{ /* sentinel */ }
};
MODULE_DEVICE_TABLE(of, imx_cs4344_dt_ids);

static struct platform_driver imx_cs4344_driver = {
	.driver = {
		.name = "imx-cs4344",
		.pm = &snd_soc_pm_ops,
		.of_match_table = imx_cs4344_dt_ids,
	},
	.probe = imx_cs4344_probe,
};
module_platform_driver(imx_cs4344_driver);

MODULE_AUTHOR("Freescale Semiconductor, Inc.");
MODULE_DESCRIPTION("Freescale i.MX CS4344 ASoC machine driver");
MODULE_LICENSE("GPL v2");
MODULE_ALIAS("platform:imx-cs4344");
