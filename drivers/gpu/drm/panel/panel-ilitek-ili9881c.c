...
static void ili9881c_getID(struct ili9881c_panel *tftcp)
{
	...
	printk("MIPI-DSI panel ili9881 detect ID: 0x%02X 0x%02X 0x%02X \n", id[0], id[1], id[2]);
}
...
static const struct display_timing ph720128t003_timing = {
    .pixelclock = { 64000000, 66000000, 71000000 },
	.hactive = { 720, 720, 720 },
			     ...
			     struct drm_connector *connector)
{
	...
	mode = drm_mode_duplicate(drm, &default_mode);
	if (!mode) {
