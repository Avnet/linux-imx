...
#define MAAX_IOC_MMAP_GPIO1_REG		_IOWR(MAAX_IOC_MAGIC, 1,unsigned short)
#define MAAX_IOC_MMAP_GPIO2_REG		_IOWR(MAAX_IOC_MAGIC, 2,unsigned short)
#define MAAX_IOC_MMAP_GPIO3_REG		_IOWR(MAAX_IOC_MAGIC, 3,unsigned short)
#define MAAX_IOC_MMAP_GPIO4_REG		_IOWR(MAAX_IOC_MAGIC, 4,unsigned short)
#define MAAX_IOC_MMAP_GPIO5_REG		_IOWR(MAAX_IOC_MAGIC, 5,unsigned short)
...
*/
#define GPIO1_FUNCTION_BASE_ADDR		0x30200000
#define GPIO2_FUNCTION_BASE_ADDR		0x30210000
#define GPIO3_FUNCTION_BASE_ADDR		0x30220000
#define GPIO4_FUNCTION_BASE_ADDR		0x30230000
#define GPIO5_FUNCTION_BASE_ADDR		0x30240000

#define GPIO_FUNCTION_AREA_SIZE		0x4000
